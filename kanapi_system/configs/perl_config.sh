...
config_args='-E -Dprefix=@KANAPI_ROOT@/packages/perl-5.24.0 -Dcf_email=jacek.m.danecki@gmail.com -Dlocincpth=@KANAPI_ROOT@/packages/glibc-2.23/include @KANAPI_ROOT@/packages/zlib-1.2.8/include -Dloclibpth=@KANAPI_ROOT@/packages/glibc-2.23/lib @KANAPI_ROOT@/packages/zlib-1.2.8/lib -Dlibswanted=pthread rt m dl nsl crypt util c z -Dusethreads -Dcc=gcc'
config_argc=8
config_arg1='-E'
config_arg2='-Dprefix=@KANAPI_ROOT@/packages/perl-5.24.0'
config_arg3='-Dcf_email=jacek.m.danecki@gmail.com'
config_arg4='-Dlocincpth=@KANAPI_ROOT@/packages/glibc-2.23/include @KANAPI_ROOT@/packages/zlib-1.2.8/include'
config_arg5='-Dloclibpth=@KANAPI_ROOT@/packages/glibc-2.23/lib @KANAPI_ROOT@/packages/zlib-1.2.8/lib'
...
alignbytes='8'
ansi2knr=''
aphostname='@KANAPI_ROOT@/bin/hostname'
api_revision='5'
api_subversion='0'
api_version='24'
api_versionstring='5.24.0'
ar='ar'
archlib='@KANAPI_ROOT@/packages/perl-5.24.0/lib/5.24.0/x86_64-linux-thread-multi'
archlibexp='@KANAPI_ROOT@/packages/perl-5.24.0/lib/5.24.0/x86_64-linux-thread-multi'
archname64=''
...
baserev='5.0'
bash=''
bin='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
bin_ELF='define'
binexp='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
bison='bison'
byacc='byacc'
byteorder='12345678'
c=''
...
cccdlflags='-fPIC'
ccdlflags='-Wl,-E'
ccflags='-D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong -I@KANAPI_ROOT@/packages/glibc-2.23/include -I@KANAPI_ROOT@/packages/zlib-1.2.8/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
...
cpp_stuff='42'
cppccsymbols=''
cppflags='-D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong -I@KANAPI_ROOT@/packages/glibc-2.23/include -I@KANAPI_ROOT@/packages/zlib-1.2.8/include'
cpplast='-'
cppminus='-'
cpprun='gcc  -E'
cppstdin='gcc  -E'
...
incpth=''
inews=''
initialinstalllocation='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
installarchlib='@KANAPI_ROOT@/packages/perl-5.24.0/lib/5.24.0/x86_64-linux-thread-multi'
installbin='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
installhtml1dir=''
installhtml3dir=''
installman1dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man1'
installman3dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man3'
installprefix='@KANAPI_ROOT@/packages/perl-5.24.0'
installprefixexp='@KANAPI_ROOT@/packages/perl-5.24.0'
installprivlib='@KANAPI_ROOT@/packages/perl-5.24.0/lib/5.24.0'
installscript='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
installsitearch='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl/5.24.0/x86_64-linux-thread-multi'
installsitebin='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
installsitehtml1dir=''
installsitehtml3dir=''
installsitelib='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl/5.24.0'
installsiteman1dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man1'
installsiteman3dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man3'
installsitescript='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
installstyle='lib'
...
lddlflags='-shared -O2 -L@KANAPI_ROOT@/packages/glibc-2.23/lib -L@KANAPI_ROOT@/packages/zlib-1.2.8/lib -fstack-protector-strong'
ldflags=' -fstack-protector-strong -L@KANAPI_ROOT@/packages/glibc-2.23/lib -L@KANAPI_ROOT@/packages/zlib-1.2.8/lib'
...
libsdirs=' @KANAPI_ROOT@/packages/glibc-2.23/lib @KANAPI_ROOT@/packages/zlib-1.2.8/lib'
libsfiles=' libpthread.so librt.so libm.so libdl.so libnsl.so libcrypt.so libutil.so libc.so libz.so'
libsfound=' @KANAPI_ROOT@/packages/glibc-2.23/lib/libpthread.so @KANAPI_ROOT@/packages/glibc-2.23/lib/librt.so @KANAPI_ROOT@/packages/glibc-2.23/lib/libm.so @KANAPI_ROOT@/packages/glibc-2.23/lib/libdl.so @KANAPI_ROOT@/packages/glibc-2.23/lib/libnsl.so @KANAPI_ROOT@/packages/glibc-2.23/lib/libcrypt.so @KANAPI_ROOT@/packages/glibc-2.23/lib/libutil.so @KANAPI_ROOT@/packages/glibc-2.23/lib/libc.so @KANAPI_ROOT@/packages/zlib-1.2.8/lib/libz.so'
libspath=''
...
lkflags=''
ln='ln'
lns='@KANAPI_ROOT@/bin/ln -s'
localtime_r_proto='REENTRANT_PROTO_S_TS'
locincpth='@KANAPI_ROOT@/packages/glibc-2.23/include @KANAPI_ROOT@/packages/zlib-1.2.8/include'
loclibpth='@KANAPI_ROOT@/packages/glibc-2.23/lib @KANAPI_ROOT@/packages/zlib-1.2.8/lib'
...
mallocsrc=''
malloctype='void *'
man1dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man1'
man1direxp='@KANAPI_ROOT@/packages/perl-5.24.0/man/man1'
man1ext='1'
man3dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man3'
man3direxp='@KANAPI_ROOT@/packages/perl-5.24.0/man/man3'
man3ext='3'
mips_type=''
mistrustnm=''
mkdir='mkdir'
...
perlpath='@KANAPI_ROOT@/packages/perl-5.24.0/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
plibpth=''
pmake=''
pr=''
prefix='@KANAPI_ROOT@/packages/perl-5.24.0'
prefixexp='@KANAPI_ROOT@/packages/perl-5.24.0'
privlib='@KANAPI_ROOT@/packages/perl-5.24.0/lib/5.24.0'
privlibexp='@KANAPI_ROOT@/packages/perl-5.24.0/lib/5.24.0'
procselfexe=''
prototype='define'
ptrsize='8'
quadkind='2'
...
revision='5'
rm='rm'
rm_try='@KANAPI_ROOT@/bin/rm -f try try a.out .out try.[cho] try..o core core.try* try.core*'
rmail=''
run=''
runnm='false'
...
scriptdir='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
scriptdirexp='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
sed='sed'
...
sig_size='69'
signal_t='void'
sitearch='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl/5.24.0/x86_64-linux-thread-multi'
sitearchexp='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl/5.24.0/x86_64-linux-thread-multi'
sitebin='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
sitebinexp='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
sitehtml1dir=''
sitehtml1direxp=''
sitehtml3dir=''
sitehtml3direxp=''
sitelib='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl/5.24.0'
sitelib_stem='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl'
sitelibexp='@KANAPI_ROOT@/packages/perl-5.24.0/lib/site_perl/5.24.0'
siteman1dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man1'
siteman1direxp='@KANAPI_ROOT@/packages/perl-5.24.0/man/man1'
siteman3dir='@KANAPI_ROOT@/packages/perl-5.24.0/man/man3'
siteman3direxp='@KANAPI_ROOT@/packages/perl-5.24.0/man/man3'
siteprefix='@KANAPI_ROOT@/packages/perl-5.24.0'
siteprefixexp='@KANAPI_ROOT@/packages/perl-5.24.0'
sitescript='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
sitescriptexp='@KANAPI_ROOT@/packages/perl-5.24.0/bin'
sizesize='8'
sizetype='size_t'
sleep=''
smail=''
...
st_ino_sign='1'
st_ino_size='8'
startperl='#!@KANAPI_ROOT@/packages/perl-5.24.0/bin/perl'
startsh='#!/bin/sh'
static_ext=' '
stdchar='char'
